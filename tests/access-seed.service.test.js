...
describe("accessSeedService.ensureCoreAccessSeed", () => {
  ...
  it("upserts permissions and the admin role with the initial matrix", async () => {
    const permissionCodes = [
      ...
      "CONTENT_IDEA_READ",
      "CONTENT_PRODUCTION_CREATE",
      "CONTENT_PRODUCTION_READ",
      "CONTENT_PRODUCTION_UPDATE",
      "CONTENT_PRODUCTION_ACTION",
      "REEL_CREATE",
      "REEL_UPDATE",
      "CAROUSEL_CREATE",
      "CAROUSEL_UPDATE",
      ...
      "APPROVALS_MANAGEMENT_READ",
      "APPROVALS_MANAGEMENT_DECIDE",
      "PUBLICATION_CREATE",
      "PUBLICATION_READ",
      "PUBLICATION_UPDATE",
