...
describe("app", () => {
  ...
  it("should expose the api root endpoint", async () => {
    ...
    expect(response.body.modules).toContain("approvals-management");
    ...
    expect(response.body.modules).toContain("social-media");
    ...
    expect(response.body.modules).toContain("traffic-management");
    ...
    expect(response.body.modules).toContain("reports");
